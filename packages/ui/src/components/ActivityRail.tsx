...
// three blocks are the dimensions it does not carry:
//
...
//           gap worth filling.
//
// All three derive from the same range-filtered `activities` the feed renders,
...
export function ActivityRail({ activities, timezone }: { activities: ActivityDTO[]; timezone: string }) {
  ...
  return (
    <aside className="activity-rail" aria-label="Who, where and when">
      <div className="rail-block">
        <div className="rail-block-head">
