...
- `emit` produces contract major v4, currently `4.2.1`, and validates the JSON
...
`.env` in the **compose project directory** (`docker/.env` for `docker compose -f
...
The current emitted contract is major v4, currently `4.2.1`. The canonical
